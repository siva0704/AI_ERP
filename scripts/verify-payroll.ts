...
const API_URL = 'http://127.0.0.1:4000/api'; // CONFIRM PORT AFTER VIEWING main.ts
...
async function run() {
    ...
    try {
        ...
        // Verification Assertion implies: Base 3000, 2 Absent => 2 * (3000/30 = 100) = 200 Deduction. Net 2800.
        // Prisma Decimal returns as string in JSON usually, or number depending on settings.
